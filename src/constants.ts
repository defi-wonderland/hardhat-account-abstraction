...
export const createXFactory = '0xba5Ed099633D3B313e4D5F7bdc1305d3c28ba5Ed';

export const mainFolderName = './sponsored-transactions';

export const latestFolderName = `${mainFolderName}/run-latest`;
